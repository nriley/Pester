...
#define kStrMoveApplicationQuestionInfoOnDiskImage _I10NS(@"You can then safely move the disk image to the Trash.")
...
// set this to 0.
#define PFUseSmallAlertSuppressCheckbox 0
...
void PFMoveToApplicationsFolderIfNecessary(void) {
    ...
    NSAlert *alert = [NSAlert new];
    {
        ...
        if (diskImageDevice) {
            ...
            informativeText = [NSString stringWithFormat:@"%@\n\n%@", informativeText, kStrMoveApplicationQuestionInfoOnDiskImage];
        }

        if (needAuthorization) {
            informativeText = [NSString stringWithFormat:@"%@\n\n%@", informativeText, kStrMoveApplicationQuestionInfoWillRequirePasswd];
            ...
            informativeText = [NSString stringWithFormat:@"%@\n\n%@", informativeText, kStrMoveApplicationQuestionInfoInDownloadsFolder];
        }
