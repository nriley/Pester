...
//
// $Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniAppKit/Widgets.subproj/OACalendarView.h,v 1.16 2002/12/07 00:23:40 andrew Exp $
...
- (void)calendarViewShouldDismiss:(OACalendarView *)aCalendarView;	// implement this on the target if you want to know when someone double-clicks on a day
@end
...
@interface OACalendarView : NSControl
{
    ...
    struct {
        ...
        unsigned int targetReceivesDismiss:1;
    } flags;
}
